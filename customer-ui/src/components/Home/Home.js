...
class Home extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      errorMessage: "",
      orderID: "",
      comment: "Your Order is being prepared! Thank you!",
    };
  }
  componentDidMount() {
    axios
      .get(API_URL.GET_LOCATIONS)
      .then((response) => {
    ...
    return (
      <div className="home__base">
        {this.state.isOrder ? (
          ...
          <div>
            <div>
              <h2 className="welcome__text"> SOFT DRINK ORDER PAGE </h2>
            ...
            <div className="order__base">
              <form className="order__form" onSubmit={this.handleOrder}>
                ...
                <div className="order__line">
                  <label className="order__label">Drink</label>
                  <input list="coffee" onChange={this.handleTypeChange} />
                  <datalist id="coffee">
                    <option value="COCOCOLA" />
