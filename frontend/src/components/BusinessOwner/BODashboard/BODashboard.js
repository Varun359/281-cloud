      ...
      <div className="bodashboard">
        ...
        <div className="bodashboard__header">
          <div className="customerdashboard__usergreeting">
            ...
            <span className="customerdashboard__user">
              {this.state.business_account}
            </span>
          </div>
          <div className="bodashboard__logout">
            <button className="btn__logout" onClick={this.handleLogout}>
              Logout
            </button>
          </div>
        </div>
        ...
        <div className="bodashboard__currentpage">{currentPage}</div>
        {/* </div> */}
      </div>
    );
  }
