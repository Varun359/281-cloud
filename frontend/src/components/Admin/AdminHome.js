...
class AdminHome extends Component {
  ...
  getRobots(accountId) {
    ...
    var requestGetRobotsUrl =
      API_URL + this.getRobotsSuffix + "?accountId=" + accountId;
      ...
      <div>
        ...
        {this.state.selectedBusiness ? (
          <div>
                        ...
                        <div>
                          {robot.state == "PAUSED" ? (
                            <button
                              ...
                              data-item={robot}
                              onClick={() =>
                                this.handleRobotState(robot, "RUNNING")
                              }
                            >
                              RESUME
                            </button>
                          ...
                          {robot.state == "RUNNING" ? (
                            <button
                              ...
                              data-item={robot}
                              onClick={() =>
                                this.handleRobotState(robot, "PAUSED")
                              }
                            >
                              PAUSE
                            </button>
            ...
            <div>
              <button className="btn" onClick={this.handleCreated}>
                {" "}
                Rent Robot{" "}
              </button>
